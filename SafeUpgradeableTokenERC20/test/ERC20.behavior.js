...
function shouldBehaveLikeERC20Approve (errorPrefix, owner, spender, supply, approve, internal) {
    ...
    describe('when the sender has enough balance', function () {
      ...
      describe('when the spender had an approved amount', function () {
        ...
        if (internal) {
          ...
          it('reverts', async function () {
            await shouldFail.reverting.withMessage(approve.call(this, owner, spender, amount),
              `${errorPrefix}: must change allowance to 0 before changing to a different value`
            );
          });
        }
      });
